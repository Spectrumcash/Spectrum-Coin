...
!define URL http://www.Spectrum.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Spectrum.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Spectrum-qt.exe
...
OutFile Spectrum-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Spectrum-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Spectrumd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Spectrum.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Spectrum-qt.exe
